...
public class BankOfAmerica {
    ...
    public static void main(String[] args) {
        ...
        tester1.setTesterInfo("Leyla",123456,"SDET",100000);

        Tester tester2 = new Tester();
        tester2.setTesterInfo("Venera",123456786,"Senior SDET",150000);
        ...
        tester5.setTesterInfo("John", 222, "Uber driver",60000);
