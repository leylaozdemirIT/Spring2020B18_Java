...
public class MaxNumber {
    public static void main(String[] args) {
        ...
        boolean aGreater = a > b && a > c; // if a is greater than both b and c, than a is maximum
        ...
        boolean cGreater = c > b && c > a; // if c is greater than both a and b, then c is maximum
