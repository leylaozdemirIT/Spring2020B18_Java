...
public class Scanner_Arrays {
    ...
    public static void main(String[] args) {
        ...
        for( String each  : arr  ){
            ...
            String str1 = each.charAt(0) + "" +  each.charAt(each.length()-1);  // first and last character
            System.out.println (str); // printed first 3 elements
            System.out.println("========================");
            System.out.print(str1); // printed first and last letter
        }
